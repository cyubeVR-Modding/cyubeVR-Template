...
UGetItemDailyRevenueNode* UGetItemDailyRevenueNode::GetItemDailyRevenueNode(const FString& Key, int32 AppID, const FString& ItemId, int32 DateStart, int32 DateEnd) {
    return NULL;
}
