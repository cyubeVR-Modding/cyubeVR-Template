...
UEndSecureMultiplayerSessionNode* UEndSecureMultiplayerSessionNode::EndSecureMultiplayerSessionNode(const FString& Key, FUWorksSteamID SteamID, int32 AppID, const FString& SessionId) {
    return NULL;
}
