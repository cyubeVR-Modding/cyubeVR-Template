...
void UUWorksRequestCoreDownloadLeaderboardEntriesForUsers::GetOutput(FUWorksSteamLeaderboard& SteamLeaderboard, FUWorksSteamLeaderboardEntries& SteamLeaderboardEntries, int32& EntryCount) {
}
